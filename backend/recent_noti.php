...
$user_type=$_REQUEST['user_type']; 
 ...
 if($user_type=="Parent")
  {
	  $query ="select * from notification where  notification_valid_till_date is not null and notification_valid_till_date>CURRENT_TIMESTAMP and user_type like '%$user_type%' order by notification_id desc LIMIT 2";
	  $query3 = "select * from notification where  notification_valid_till_date is not null and notification_valid_till_date>CURRENT_TIMESTAMP and  parent_id like '%$parent_email%' order by notification_id desc LIMIT 2 ";
  }
    elseif($user_type=="Faculty")
	{
		$query ="select * from notification where  notification_valid_till_date is not null and notification_valid_till_date>CURRENT_TIMESTAMP and user_type like '%$user_type%' order by notification_id desc LIMIT 2";
		$query3 = "select * from notification where  notification_valid_till_date is not null and notification_valid_till_date>CURRENT_TIMESTAMP and  faculty_id like '%$faculty_email%' order by notification_id desc  LIMIT 2";
	}
	elseif($user_type=="Alumni")
	{ 
$query ="select * from notification where  notification_valid_till_date is not null and notification_valid_till_date>CURRENT_TIMESTAMP and user_type like '%$user_type%' order by notification_id desc LIMIT 2";	
$query3 = "select * from notification where  notification_valid_till_date is not null and notification_valid_till_date>CURRENT_TIMESTAMP and  alumni_id like '%$alumni_email%' order by notification_id desc LIMIT 2";
	}
	elseif($user_type=="Student")
{

$query = "select * from notification where  notification_valid_till_date is not null and notification_valid_till_date>CURRENT_TIMESTAMP and course_id ='null' and batch='null'  and user_type like '%$user_type%' order by notification_id desc LIMIT 2";
$query1 = "select * from notification where  notification_valid_till_date is not null and notification_valid_till_date>CURRENT_TIMESTAMP and  course_id like '%$student_course%' and batch like '%$student_batch%'  order by notification_id desc LIMIT 2";
$query2 = "select * from notification where  notification_valid_till_date is not null and notification_valid_till_date>CURRENT_TIMESTAMP and  course_id like '%$student_course%' and batch='null'  order by notification_id desc LIMIT 2";
$query3 = "select * from notification where  notification_valid_till_date is not null and notification_valid_till_date>CURRENT_TIMESTAMP and  student_prn like '%$student_email%' order by notification_id desc LIMIT 2";
...
else
{
	while($row3 = mysql_fetch_array($result3)) {
        ...
        <br><div style='font-size:15px;'>".$row3['notification_body']."</div></div>  </ons-card>";
		}
	...
	while($row = mysql_fetch_array($result)) {
        ...
        <br><div style='font-size:15px;'>".$row['notification_body']."</div></div> </ons-card>";
		}
        ...
        <br><div style='font-size:15px;'>".$row2['notification_body']."</div></div> </ons-card>";
		}
	...
	while($row1= mysql_fetch_array($result1)) {
        ...
        <br><div style='font-size:15px;'>".$row1['notification_body']."</div></div> </ons-card>";
		}
