...
header("Access-Control-Allow-Origin: *");
 ...
 mysql_connect("162.222.225.87:3306","projectadmin","Password@123");
  ...
  $id=$_REQUEST['id'];
  $query = "SELECT * from meetup m inner join as_alumni_master am on m.alumni_id=am.alumni_id inner join student_master sm on sm.student_prn=am.student_prn where m.batch='$batch' and m.alumni_id='$id'";
