...
else
{
	while($row3 = mysql_fetch_array($result3)) {
        ...
        <br><div style='font-size:15px;'>".$row3['notification_body']."</div></div> <ons-button style='background-color: #33ADFF;width:30%;padding:5px;font-size:15px;margin-left:210px;' onclick='my_notify(".$row3['notification_id'].")'>VIEW</ons-button> </ons-card>";
		}
	...
	while($row = mysql_fetch_array($result)) {
        ...
        <br><div style='font-size:15px;'>".$row['notification_body']."</div></div> <ons-button style='background-color: #33ADFF;width:30%;padding:5px;font-size:15px;margin-left:210px;' onclick='my_notify(".$row['notification_id'].")'>VIEW</ons-button> </ons-card>";
		}
        ...
        <br><div style='font-size:15px;'>".$row2['notification_body']."</div></div> <ons-button style='background-color: #33ADFF;width:30%;padding:5px;font-size:15px;margin-left:210px;' onclick='my_notify(".$row2['notification_id'].")'>VIEW</ons-button> </ons-card>";
		}
	...
	while($row1= mysql_fetch_array($result1)) {
        ...
        <br><div style='font-size:15px;'>".$row1['notification_body']."</div></div> <ons-button style='background-color: #33ADFF;width:30%;padding:5px;font-size:15px;margin-left:210px;' onclick='my_notify(".$row1['notification_id'].")'>VIEW</ons-button> </ons-card>";
		}
