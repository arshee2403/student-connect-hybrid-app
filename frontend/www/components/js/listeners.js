...
Listeners.prototype.setListeners = function () {
    ...
    ConnectyCube.chat.onSystemMessageListener = this.onSystemMessageListener;
    ConnectyCube.chat.onMessageTypingListener = this.onMessageTypingListener;
    ConnectyCube.chat.onReconnectFailedListener = this.onReconnectFailedListener;

    // messaage status listeners
    ConnectyCube.chat.onSentMessageCallback = this.onSentMessageCallback.bind(this);
    ConnectyCube.chat.onDeliveredStatusListener = this.onDeliveredStatusListener.bind(this);
    ConnectyCube.chat.onReadStatusListener = this.onReadStatusListener.bind(this);
