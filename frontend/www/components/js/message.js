...
Message.prototype.sendIsTypingStatus = function (dialogId) {
    ...
    ConnectyCube.chat.sendIsTypingStatus(dialog.jidOrUserId);
};
...
Message.prototype.sendStopTypingStatus = function (dialogId) {
    ...
    ConnectyCube.chat.sendIsStopTypingStatus(dialog.jidOrUserId);
...
Message.prototype.sendMessage = function(dialogId, msg){
    ...
    message.id = ConnectyCube.chat.send(jidOrUserId, msg);
...
Message.prototype.getMessages = function (dialogId) {
    ...
    ConnectyCube.chat.message.list(params, function (err, messages) {
        if (messages) {
